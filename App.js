...
const styles = StyleSheet.create({
  ...
  qtyBtn: { padding: 10 },
  itemName:{ color:'#fff', fontWeight:'900', fontSize: 24, textAlign:'center', maxWidth:250, fontStyle: 'italic' },
  ...
  orderText:{ textAlign:'center', fontWeight:'900', letterSpacing:2, color: '#000', fontSize: 16 },
